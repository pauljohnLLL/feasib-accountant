  ...
  return (
    ...
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-[#e9ebe8] rounded-3xl p-6 md:p-10 shadow-sm">
            <motion.div variants={fadeInUp} className="flex flex-col justify-center space-y-6 pl-2 md:pl-6">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                ...
                <Link to="/#services">
                  <button className="bg-[#cfd2ce] hover:bg-[#bcbfba] text-[#0f4d16] font-bold text-sm px-8 py-3.5 rounded-full transition-colors">
                    View Free Materials
                  </button>
                </Link>
              </div>
            ...
            <motion.div variants={fadeInUp} className="relative flex justify-center w-full h-full">
              <div className="relative w-full max-w-[550px] aspect-[4/3] rounded-2xl overflow-visible shadow-xl border border-white/20 bg-white">
                ...
                <div className="absolute top-4 right-4 w-10 h-10 rounded-full bg-[#0f4d16] flex items-center justify-center shadow-md">
                  <div className="w-4 h-4 bg-white rounded-full" />
                  <div className="absolute w-4 h-4 bg-[#0f4d16] rounded-full right-2 top-1/2 -translate-y-1/2" />
                </div>
              </div>
            </motion.div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
              <motion.div variants={fadeInUp} className="lg:col-span-5 flex flex-col space-y-6 pl-2 md:pl-4">
                ...
                <div className="flex flex-col space-y-8 mt-2">
                  <div className="flex gap-4">
                    <span className="text-[#b3f0ae] font-bold text-2xl tracking-tight shrink-0">01</span>
                    <div>
                      <h4 className="font-bold text-[#0f4d16] text-base">Bespoke Modeling</h4>
                      <p className="text-[#4a5c4a] text-xs leading-relaxed mt-1 max-w-sm">
                        We don't use templates. Every projection is built from the ground up to reflect your unique industry variables and competitive landscape.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <span className="text-[#b3f0ae] font-bold text-2xl tracking-tight shrink-0">02</span>
                    <div>
                      <h4 className="font-bold text-[#0f4d16] text-base">Editorial Clarity</h4>
                      <p className="text-[#4a5c4a] text-xs leading-relaxed mt-1 max-w-sm">
                        Financial data is useless if you can't read it. Our reports are designed for executive clarity, turning complex figures into actionable narratives.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <span className="text-[#b3f0ae] font-bold text-2xl tracking-tight shrink-0">03</span>
                    <div>
                      <h4 className="font-bold text-[#0f4d16] text-base">The Grove Philosophy</h4>
                      <p className="text-[#4a5c4a] text-xs leading-relaxed mt-1 max-w-sm">
                        We balance aggressive growth with mathematical stability. We don't just find the ceiling; we build the floor.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <motion.div variants={fadeInUp} className="lg:col-span-7 relative flex flex-col h-full mt-4 lg:mt-0">
                ...
                <div className="w-full mt-4 md:mt-[-40px] relative z-10 bg-[#d6f2d4] rounded-2xl p-8 md:p-10 flex flex-col justify-center shadow-sm min-h-[220px] md:min-h-[280px]">
                  ...
                  <p className="text-[#4a5c4a] text-xs font-medium">
                    — Sarah Chen, CTO of Venturer Group
                  </p>
                </div>
              </motion.div>
            </div>
      ...
      >
        <div className="max-w-[1400px] mx-auto">
          <motion.div 
            className="max-w-4xl mx-auto bg-white rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.08)] p-8 md:p-12"
          >
            <motion.div variants={fadeInUp}>
              <h2 className="text-3xl font-bold text-[#0f4d16] mb-3">Share Your Perspective</h2>
              <div className="w-14 h-1 bg-[#0f4d16] rounded-full mb-8"></div>
            </motion.div>
            ...
            <motion.form variants={staggerContainer} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <motion.div variants={fadeInUp} className="flex flex-col space-y-1.5">
                  <label className="text-[#0f4d16] font-bold text-xs">Name</label>
                  <input 
                    type="text" 
                ...
                <motion.div variants={fadeInUp} className="flex flex-col space-y-1.5">
                  <label className="text-[#0f4d16] font-bold text-xs">Email Address</label>
                  <input 
                    type="email" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <motion.div variants={fadeInUp} className="flex flex-col space-y-1.5">
                  <label className="text-[#0f4d16] font-bold text-xs">Program/Course</label>
                  <input 
                    type="text" 
                ...
                <motion.div variants={fadeInUp} className="flex flex-col space-y-1.5">
                  <label className="text-[#0f4d16] font-bold text-xs">Education Level</label>
              ...
              <motion.div variants={fadeInUp} className="flex flex-col space-y-1.5">
                <label className="text-[#0f4d16] font-bold text-xs">School / Institution</label>
                <input 
                  type="text" 
              ...
              <motion.div variants={fadeInUp} className="flex flex-col space-y-1.5">
                <label className="text-[#0f4d16] font-bold text-xs">Feedback</label>
                <textarea 
                  rows={4}
